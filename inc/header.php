...
,
    ...
    'memory.limit' => 'Memory limit (history size)',
    'hint.memory_limit' => 'Maximum number of messages (user+assistant) to include in the context for responses. Default: 50.',
...
,
    ...
    'memory.limit' => 'Ограничение памяти (максимум сообщений в контексте)',
    'hint.memory_limit' => 'Максимальное количество сообщений (user+assistant) для загрузки в контекст при ответе. По умолчанию 50.',
